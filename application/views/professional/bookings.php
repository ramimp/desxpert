					...
					<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
						...
						<div class="card card-custom gutter-b card-stretch">
							...
							<div class="card-body pt-4">
								...
								<div class="d-flex align-items-center mb-7">
									...
									<div class="flex-shrink-0 mr-4 mt-lg-0 mt-3">
										<div class="symbol symbol-circle symbol-lg-75">
											<?php 
												if($book->oauth_provider=='individual' || $book->oauth_provider=='company') 
												{
													$picture = base_url() . 'assets/media/users/' . $book->picture;
												}
												else
												{
									...
									<div class="d-flex flex-column">
										...
										<span class="text-muted font-weight-bold">
											<?php 
												if($book->oauth_provider!='company')
													echo 'Individual';
												else
													echo 'Company';
											 ?>
								...
								<!--begin::Desc-->
								<p class="mb-7">
									<?php echo substr($book->short_desc,0, 50) . '...'; ?>
								</p>
								<!--end::Desc-->
								<!--begin::Info-->
								<div class="mb-7">
                ...
                <div data-scroll="true" data-height="300">
	                ...
	                <div id="booking_body" hidden>
	                	<div class="form-group row">
							...
							<label class="col-xl-5 col-lg-3 col-form-label">Client Name: </label>
							...
							<label class="col-xl-5 col-lg-3 col-form-label">Date Scheduled: </label>
							<div class="col-lg-9 col-xl-7">
								<p class="form-text text-muted pt-2">
							...
							<label class="col-xl-5 col-lg-3 col-form-label">Time: </label>
							<div class="col-lg-9 col-xl-7">
								<p class="form-text text-muted pt-2">
							...
							<label class="col-xl-5 col-lg-3 col-form-label">Status: </label>
							<div class="col-lg-9 col-xl-7">
								<p class="form-text text-muted pt-2">
							...
							<label class="col-xl-5 col-lg-3 col-form-label">Short Description: </label>
							<div class="col-lg-9 col-xl-7">
								<p class="form-text text-muted pt-2">
							...
							<label class="col-xl-5 col-lg-3 col-form-label">Duration: </label>
							<div class="col-lg-9 col-xl-7">
								<p class="form-text text-muted pt-2">
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
    	<div class="modal-content">
	        ...
	        <div class="modal-footer">
	            ...
	            <button type="button" class="btn btn-light-success font-weight-bold btn_yes" onclick="updateBookingStatus('Accepted')">
	            	Yes, I'll accept
	            </button>
	        </div>
    	</div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
    	<div class="modal-content">
	        ...
	        <div class="modal-footer">
	            ...
	            <button type="button" class="btn btn-light-danger font-weight-bold btn_yes" onclick="updateBookingStatus('Decline')">Yes, I'll decline</button>
	        </div>
    	</div>
    </div>
</div>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/prof_bookings.js"></script>
