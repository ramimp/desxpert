							...
							<div class="flex-grow-1 card-spacer-x">
									...
									<div class="d-flex align-items-center mr-2">
										<div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
											<div class="symbol-label">
												<img src="/metronic/theme/html/demo2/dist/assets/media/svg/misc/006-plurk.svg" alt="" class="h-50" />
											</div>
										</div>
										<div>
								...
								<div class="d-flex align-items-center justify-content-between mb-10">
									<div class="d-flex align-items-center mr-2">
										<div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
											<div class="symbol-label">
												<img src="/metronic/theme/html/demo2/dist/assets/media/svg/misc/015-telegram.svg" alt="" class="h-50" />
											</div>
										</div>
										<div>
								...
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center mr-2">
										<div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
											<div class="symbol-label">
												<img src="/metronic/theme/html/demo2/dist/assets/media/svg/misc/003-puzzle.svg" alt="" class="h-50" />
											</div>
										</div>
										<div>
				...
				<div class="col-xl-8">
					<div class="row">
						<div class="col-xl-3">
							...
							<div class="card card-custom bgi-no-repeat bgi-no-repeat bgi-size-cover gutter-b" style="height: 150px; background-image: url(/metronic/theme/html/demo2/dist/assets/media/bg/bg-9.jpg)">
								<!--begin::Body-->
					...
					<div class="row">
						<div class="col-xl-6">
							...
							<div class="card card-custom bgi-no-repeat gutter-b" style="height: 175px; background-color: #663259; background-position: calc(100% + 0.5rem) 100%; background-size: 100% auto; background-image: url(/metronic/theme/html/demo2/dist/assets/media/svg/patterns/taieri.svg)">
								<!--begin::Body-->
						...
						<div class="col-xl-6">
							...
							<div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b card-stretch" style="background-image: url(/metronic/theme/html/demo2/dist/assets/media/stock-600x600/img-16.jpg)">
								<!--begin::Body-->
									...
									<tbody>
											...
											<td class="pr-0">
												<div class="symbol symbol-50 symbol-light mt-1">
													<span class="symbol-label">
														<img src="/metronic/theme/html/demo2/dist/assets/media/svg/avatars/001-boy.svg" class="h-75 align-self-end" alt="" />
													</span>
												</div>
											</td>
											<td class="pl-0">
										...
										<tr>
											...
											<td class="pr-0">
												<div class="symbol symbol-50 symbol-light mt-1">
													<span class="symbol-label">
														<img src="/metronic/theme/html/demo2/dist/assets/media/svg/avatars/018-girl-9.svg" class="h-75 align-self-end" alt="" />
													</span>
												</div>
											</td>
											<td class="pl-0">
										...
										<tr>
											...
											<td class="pr-0">
												<div class="symbol symbol-50 symbol-lightv mt-1">
													<span class="symbol-label">
														<img src="/metronic/theme/html/demo2/dist/assets/media/svg/avatars/047-girl-25.svg" class="h-75 align-self-end" alt="" />
													</span>
												</div>
											</td>
											<td class="pl-0">
										...
										<tr>
											...
											<td class="pr-0">
												<div class="symbol symbol-50 symbol-light mt-1">
													<span class="symbol-label">
														<img src="/metronic/theme/html/demo2/dist/assets/media/svg/avatars/014-girl-7.svg" class="h-75 align-self-end" alt="" />
													</span>
												</div>
											</td>
											<td class="pl-0">
					...
					<div class="card card-custom card-stretch gutter-b">
						...
						<div class="card-body d-flex flex-column">
							...
							<div class="d-flex align-items-center">
								...
								<a href="#" class="symbol symbol-45 symbol-light mr-3">
									<div class="symbol-label">
										<img src="/metronic/theme/html/demo2/dist/assets/media/svg/avatars/028-girl-16.svg" class="h-75 align-self-end" alt="" />
									</div>
								</a>
								<!--end::Pic-->
								<!--begin::Pic-->
								<a href="#" class="symbol symbol-45 symbol-light">
									<div class="symbol-label">
										<img src="/metronic/theme/html/demo2/dist/assets/media/svg/avatars/024-boy-9.svg" class="h-75 align-self-end" alt="" />
									</div>
								</a>
								<!--end::Pic-->
							</div>
					...
					<div class="card card-custom card-stretch gutter-b">
						...
						<div class="card-body d-flex flex-column">
							...
							<div class="d-flex align-items-center">
								...
								<a href="#" class="symbol symbol-45 symbol-light">
									<div class="symbol-label">
										<img src="/metronic/theme/html/demo2/dist/assets/media/svg/avatars/005-girl-2.svg" class="h-75 align-self-end" alt="" />
									</div>
								</a>
								<!--end::Pic-->
							</div>
