...
<!--end::Content-->             
<script src="<?php echo base_url(); ?>assets/plugins/custom/fullcalendar/fullcalendar.bundle.js?v=7.1.2"></script>
<script src="<?php echo base_url(); ?>assets/js/pages/features/calendar/basic.js?v=7.1.2"></script>