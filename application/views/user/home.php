		...
		<div id="div_book_now"  class="container-fluid" style="margin: 0px; padding: 0px;" hidden>
			...
			<div class="col-lg-12 col-xl-12 mb-12" style="padding: 10px;">
				<div class="container">
                    ...
                    <!--begin::Div Loading-->
					<div id="div_no_response" hidden>
						<div class="text-center">
							<h3 class="text-danger font-weight-bold my-7 mr-5">
								No available lawyer as of now <br> Please try again later.
							</h3>
						</div>
                    </div>
                    <!--end::Div Loading-->
                    ...
                    <!--begin::Div Result-->
                    <div id="available_msg" class="col-lg-12 col-md-12 col-sm-12" hidden>
						<h3 class="text-muted font-weight-bold my-5 mr-5 text-uppercase">
							Available Lawyer(s)
						</h3>
					</div>
					<div id="div_available_lawyers" class="row" hidden>
						<!--begin::Col--> <!--end::Col-->
					</div>
					<!--end::Div Result-->
											...
											<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
												...
												<div class="card card-custom gutter-b card-stretch card-home shadow">
													...
													<div class="card-body pt-4">
														...
														<!--end::Info-->
														<a href="<?php echo base_url() ?>booking/request/<?php echo $prof->professional_id; ?>" class="btn btn-block btn-sm btn-custom2 font-weight-bolder text-uppercase py-4">
															Book
														</a>
													</div>
													<!--end::Body-->
