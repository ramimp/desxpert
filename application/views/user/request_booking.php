...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
		...
		<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex flex-column">
					<h1 class="text-white font-weight-bolder my-5 mr-5">DesxPert | Request Booking</h1>
					...
					<!-- <div class="d-flex align-items-center font-weight-bold my-2">
						<button id="btn_toggle" type="button" class="btn btn-custom1">
							Instant Booking
						</button>
					</div> -->
				</div>
									...
									<form class="form" id="kt_form">
											...
											<div class="row">
												...
												<div class="col-xl-6">
													...
													<div class="form-group">
														...
														<div class="input-group date">
													     	<input value="<?php echo $tom; ?>" name="date" id="kt_datepicker_1" type="text" class="form-control" readonly  placeholder="Select date"/>
													    ...
													    <span class="form-text text-muted">
															Please select date of consultation.
														</span>
													</div>
													<!--end::Input-->
												</div>
													...
													<div class="form-group row">
												        ...
												        <div class="col-9 col-form-label">
												            <div class="radio-list">
												                <div id="div_time"> <?php echo $time; ?> </div>
												            </div>
															<div id="div_loader" hidden>
												...
												<div class="col-xl-12">
													<div class="form-group">
														...
														<textarea name="short_desc" class="form-control" id="kt_maxlength_5" maxlength="500" placeholder="Short description" rows="6"></textarea>
														<span class="form-text text-muted">
															Please select enter short description.
														</span>
													</div>
												</div>
											...
											<div class="row">
											    ...
											    <div class="col-lg-6">
										     		<label class="option">
										      			<span class="option-control">
										       				<span class="radio">
											        			<input type="radio" name="m_option_1" value="Other"/>
											        			<span></span>
										       				</span>
										      			</span>
											     			<span class="option-label">
														       ...
														       <span class="option-body">
														        	Payment via bank, bayad center, etc. <br>
														        	<span class="text-muted">
														        		In this you option, you will upload the proof of payment photo.
														        	</span>
														       </span>
										      				</span>
										     		</label>
										...
										<div class="d-flex justify-content-between border-top mt-5 pt-10">
											...
											<div>
												...
												<button id="btn_request" type="submit" class="btn btn-custom2 font-weight-bolder text-uppercase px-9 py-4" data-wizard-type="action-submit">
													Request Book
												</button>
	...
	<!--begin::Entry-->
	<div class="d-flex flex-column-fluid">
		<div class="container" id="div_book_instant" hidden>
			<div class="card card-custom" style="box-shadow: 5px 10px 18px #888888;">
				<div class="card-header">
			  		<div class="card-title">
			   			<h3 class="card-label text-uppercase">
				...
				<div class="card-body p-0">
					...
					<!--begin: Wizard 2-->
					<div class="wizard wizard-2" id="kt_wizard_v3" data-wizard-state="step-first" data-wizard-clickable="false">
						<!--begin: Wizard Nav-->
						<div class="wizard-nav border-right py-8 px-8 py-lg-20 px-lg-10">
							<!--begin::Wizard Step 1 Nav-->
							<div class="wizard-steps">
						...
						<div class="wizard-body py-8 px-8 py-lg-20 px-lg-10">
							...
							<div class="row">
								<div class="offset-xxl-2 col-xxl-8">
									<form class="form" id="kt_form_instant">
										...
										<div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
											...
											<label class="mb-10 font-weight-bold text-dark text-muted">
												<b>NOTE:</b> Any of these following lawyers will join you in zoom meeting. <br> Our system will generate the available lawyer for you.
											</label>
														...
														<div class="card-body pt-4">
															...
															<div class="d-flex align-items-end mb-7">
																...
																<div class="d-flex align-items-center">
																	...
																	<div class="flex-shrink-0 mr-4 mt-lg-0 mt-3">
																		<div class="symbol symbol-circle symbol-lg-75">
																			<img src="<?php echo base_url() ?>assets/media/professionals/100_3.jpg">
																		</div>
																		<div class="symbol symbol-lg-75 symbol-circle symbol-primary d-none">
																			<span class="font-size-h3 font-weight-boldest">JM</span>
																		</div>
																	...
																	<div class="d-flex flex-column">
																		...
																		<a href="<?php echo base_url() ?>home/profile" class="text-dark font-weight-bold text-hover-primary font-size-h5 mb-0">Atty. Luca Doncic</a>
																		<span class="text-muted font-weight-bold">Lawyer</span>
																	</div>
																	<!--end::Title-->
																</div>
											...
											<div class="row">
												<div class="col-xl-12">
													<div class="form-group">
														<label>Hour(s) of consultation</label>
														...
														<span class="form-text text-muted">
															Please select Hour(s) of consultation.
														</span>
													</div>
												</div>
											</div>
											...
											<div class="row">
												...
												<div class="col-lg-6">
										     		<label class="option">
										      			<span class="option-control">
										       				<span class="radio">
										        			<input type="radio" name="m_option_2" value="paypal" checked="checked"/>
										        			<span></span>
										       				</span>
										      			</span>
											     			<span class="option-label">
										    	...
										    	<div class="col-lg-6">
											     	<label class="option">
											      		<span class="option-control">
											       			<span class="radio">
												        		<input type="radio" name="m_option_2" value="gcash"/>
												        		<span></span>
											       			</span>
											      		</span>
											      		<span class="option-label">
											    ...
											    <div class="col-lg-6">
										     		<label class="option">
										      			<span class="option-control">
										       				<span class="radio">
										        			<input type="radio" name="m_option_2" value="Other"/>
										        			<span></span>
										       				</span>
										      			</span>
											     			<span class="option-label">
														       ...
														       <span class="option-body">
														        	Payment via bank, bayad center, etc.
														       </span>
										      				</span>
										     		</label>
										    	</div>
										...
										<div class="pb-5" data-wizard-type="step-content">
											...
											<!--begin::Section-->
											<h4 class="mb-10 font-weight-bold text-dark">Review your Details and Submit</h4>
											<h6 class="font-weight-bolder mb-3">Professionals:</h6>

											<div class="text-dark-50 line-height-lg mb-10">
												<div> 
													<b>NOTE:</b> Any of these following lawyers will join you in zoom meeting. <br> Our system will generate the available lawyer for you.
												</div>
											</div>
										...
										<div class="d-flex justify-content-between border-top mt-5 pt-10">
											...
											<div>
												<button type="submit" class="btn btn-custom2 font-weight-bolder text-uppercase px-9 py-4" data-wizard-type="action-submit">Submit</button>
												<button type="button" class="btn btn-custom2 font-weight-bolder text-uppercase px-9 py-4" data-wizard-type="action-next">Next</button>
											</div>
										</div>
										<!--end: Wizard Actions-->
	...
	<!--begin::Entry-->
	<div class="d-flex flex-column-fluid">
		<div class="container" id="div_join" hidden>
			<!--begin::Card-->
			<div class="col-lg-12 col-xl-12 mb-12 bg-white" style="box-shadow: 5px 10px 18px #888888;">
				<div class="container">
					<div class="row">

						<div class="col-lg-12 col-md-12 col-sm-12">
							<h2 class="font-weight-bold my-10 text-uppercase text-center text-success">
								Success!
								<br>
								<small class="text-muted">You can now join a meeting by clicking button below.</small>
							</h2>
							<center>
								<button id="btn_join" type="button" class="my-10 btn btn-custom2 text-uppercase font-weight-bold">
									Join Zoom
								</button>
							</center>
						</div>
...
<script src="<?php echo base_url(); ?>assets/js/pages/crud/forms/widgets/bootstrap-timepicker.js?v=7.1.1"></script>
<script src="<?php echo base_url(); ?>assets/js/pages/crud/forms/widgets/bootstrap-select.js?v=7.1.1"></script>
...
<script src="<?php echo base_url(); ?>assets/js/pages/custom/wizard/wizard-1.js?v=7.1.1"></script>
<script src="<?php echo base_url(); ?>assets/js/request_booking.js"></script>
<!--end::Page Scripts-->