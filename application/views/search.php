		...
		<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				...
				<div class="d-flex flex-column">
					<!--begin::Title-->
					<h2 class="text-white font-weight-bold my-2 mr-5">Search</h2>
					<!--end::Title-->
				</div>
				<!--end::Heading-->
			</div>
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
						...
						<div class="card card-custom gutter-b card-stretch" style="box-shadow: 5px 10px 18px #888888;">
							...
							<div class="card-body text-center pt-4">
								...
								<!--begin::Buttons-->
								<div class="mt-9 mb-6">
									<a id="<?php echo $prof->professional_id; ?>" class="btn btn-md btn-icon btn-light-twitter btn-pill mx-2 book_appointment" data-toggle="modal" data-target="#login-modal">
										<i class="fa fa-book"></i>
									</a>
									<a href="<?php echo base_url()?>home/prof/<?php echo $prof->professional_id; ?>"  class="btn btn-md btn-icon btn-light-twitter btn-pill mx-2">
										<i class="fa fa-eye"></i>
									</a>
								</div>
								<!--end::Buttons-->
